...
import { describeApplication, computeApplicationSummary, worksValueToDate, isMeasurableWorks, variationValue, variationValueToDate, materialLineTotal, materialValueToDate } from './applications'
...
export async function buildApplicationPDF({ app, appNumber, project = {}, prevGross = 0, prevReleases = null, trackerVariations = [], logoUrl }) {
  ...
  const isInstructed = (v) => v.instructed === true || v.instructed === 'yes'
