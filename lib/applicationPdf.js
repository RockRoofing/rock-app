...
export async function buildApplicationPDF({ app, appNumber, project = {}, prevGross = 0, prevReleases = null, trackerVariations = [], logoUrl }) {
  ...
  page.drawText(san(desc.title), { x: M + (logoImg ? 60 : 0), y: y - 22, size: 20, font: bold, color: INK })
  ...
  const banner = [
    isFinal ? 'FINAL ACCOUNT - this is the last application on this project' : null,
