...
export async function buildProjectReportPDF({ report, logoUrl }) {
  ...
  page.drawText(done ? 'STATUS: COMPLETE' : 'STATUS: DRAFT', { x: M + 8, y: y - 15, size: 9.5, font: bold, color: bc })
  y -= 26
  ...
  const iss = report.issuesSnapshot || []
  ...
  // Digital signature / revision footer on every page
  const stamp = () => {
