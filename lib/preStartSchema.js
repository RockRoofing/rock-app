...
export const PRESTART_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'daPortalAccess', label: "Who from the customer's organisation or stakeholders needs access to the Rock Roofing Design Portal?", type: 'portalaccess', help: 'Add each person who needs a Design Portal login. First name, last name, email, phone and company.' },
    ],
  },
  {
    id: 'meetingActions',
    ...
    fields: [
      { id: 'meetingActions', label: 'Actions arising from this meeting', type: 'meetingactions', help: 'Each action: what needs doing, the required resolution date, and who is responsible. If a Rock Roofing portal user is responsible, a Live Project Task is created when these minutes are sent.' },
    ],
  },
]
