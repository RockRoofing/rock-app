  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'discount', label: 'Main Contractor\u2019s Discount (MCD) %', type: 'percent', required: true,
        help: 'Enter 0 if there is no discount. MCD is deducted from the gross on every application before retention is calculated, so this figure drives the Final Account on the retention register.' },
