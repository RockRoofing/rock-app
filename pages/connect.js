...
const redirectUri = encodeURIComponent(window.location.origin + '/xero-callback')
    const scope = encodeURIComponent('openid offline_access accounting.invoices.read accounting.contacts.read accounting.reports.profitandloss.read accounting.settings.read accounting.transactions.read projects.read')
