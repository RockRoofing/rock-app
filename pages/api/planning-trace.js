import { get, getOpsProjects } from '../../lib/db'
import { requireRole } from '../../lib/portalAuth'

// TEMP DIAGNOSTIC: GET /api/planning-trace?q=J203
// Shows every allocation whose project key contains the query, with dates + operatives,
// and whether a matching project exists (and its status). Delete after use.
