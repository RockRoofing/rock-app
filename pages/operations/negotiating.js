...
// Negotiating page - same CRM data, same columns. Changes to the shared
...
export default function OperationsNegotiating() {
  return (
    <OperationsShell active="pm:negotiating" section="pm" title="Negotiating" wide>
      <PageHeading title="Projects in Negotiating" sub="Live from the CRM — deals currently at the Negotiating stage" />
