                ...
                {pageRows.map(r => {
                  ...
                  return (
                    <tr key={r.id} style={{ borderTop: '1px solid #f0f0f0' }}>
                      ...
                      <td style={td}><InlineComment value={r.comments} onSave={v => patchTask(r.id, { comments: v })} /></td>
                      <td style={td}><RowAttachments files={r.attachments || []} onChange={files => patchTask(r.id, { attachments: files })} /></td>
