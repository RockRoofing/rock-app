    ...
    <>
      ...
      <div style={{ fontFamily: 'system-ui,-apple-system,sans-serif', minHeight: '100vh', background: '#fafaf9' }}>
        ...
        <div style={{ background: '#232321', padding: '0 24px', display: 'flex', gap: 4, height: 44, alignItems: 'center', overflowX: 'auto' }}>
          {[['Portal Users', '/admin'], ['Design Customers', '/admin/design-customers'], ['Templates', '/admin/templates'], ['Form Builder', '/operations/forms-builder'], ['Site App Users', '/operations/users'], ['Documents', '/admin/documents'], ['RAMS Director', '/admin/rams-director'], ['App Improvements', '/admin/problem-reports'], ['Xero Connection', '/connect']].map(([label, href]) => (
