  ...
  return (
    <Shell user={user} onLogout={() => { sessionStorage.removeItem('ops_operative'); router.push('/forms') }}>
      <div style={{ maxWidth: 620, margin: '0 auto' }}>
        <button onClick={() => router.push(router.query.from === 'browse' ? '/forms/browse' : '/forms?mode=forms')} style={{ background: 'transparent', border: 'none', color: '#888', fontSize: 14, cursor: 'pointer', padding: 0 }}>‹ Back to forms</button>
