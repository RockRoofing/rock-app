...
// Shared Handover Docs body, used by BOTH the Design portal page and the Pre-Contract page.
// Both read/write the same store (design:handover-docs:<no>) so they are a true mirror.
// Props: { projectNo, nav (element rendered above), accent (colour) }
const PURPLE = '#7c3aed'
const INK = '#1a1a19'
...
export default function HandoverDocs({ projectNo, nav }) {
